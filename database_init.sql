-- 创建数据库
CREATE DATABASE IF NOT EXISTS auto_tool CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
('user', 'user@example.com', '$2b$12$Jl5xQPsCcxu5BfI/MLLDAuy2rD8aywy2DZzNSe4NbBCjHWi3NIuOu', '测试用户', 'user')
ON DUPLICATE KEY UPDATE
    email = VALUES(email),
